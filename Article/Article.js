...
function createArticleComponents(
  ...
  classDate.textContent = date;
  p1.textContent = firstParagraph;
  p2.textContent = secondParagraph;
  p3.textContent = thirdParagraph;
  button.textContent = "Click Here";

  articleClass.appendChild(headerTitle);
  articleClass.appendChild(classDate);
  articleClass.appendChild(p1);
  articleClass.appendChild(p2);
  articleClass.appendChild(p3);
...
let mappedData = data.map(element => {
  let newMapped = createArticleComponents(
    element.title,
    element.date,
